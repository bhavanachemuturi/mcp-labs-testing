...
import { rem } from '../node_modules/@carbon/layout/es/index.js';
import { usePrefix } from '@carbon-labs/utilities/usePrefix';
import cx from 'classnames';
import debounce from '../_virtual/index.js';
...
const Resizer = /*#__PURE__*/forwardRef(({
  orientation,
  onResize,
  onResizeEnd,
  onDoubleClick,
  ...
  useEffect(() => {
    ...
    element.style[orientation === 'horizontal' ? 'blockSize' : 'inlineSize'] = rem(thickness);
